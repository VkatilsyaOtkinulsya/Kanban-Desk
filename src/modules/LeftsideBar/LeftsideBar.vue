  ...
  <aside class="leftside-bar" :class="{ 'leftside-bar--collapsed': !isOpened }">
      ...
      <a class="navigation__client">
        ...
        <div class="navigation__client-toggle">
          ...
          <span
            ...
            role="tooltip"
            :style="{
              left: isOpened ? '50%' : '210%',
            }"
          >
            {{ isOpened ? 'Свернуть боковую панель' : 'Развернуть боковую панель' }}
          </span>
        </div>
      </a>
      <div class="navigation__sections">
        <div class="navigation__sections-list">
          <div class="section-item__home">
            <div class="home__img-wrapper">
              ...
              <span v-show="isOpened">Главная</span>
            </div>
          </div>
          <div class="section-item__stats">
            <div class="icon-wrapper">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 612 612"
            ...
            <span v-show="isOpened">Активность</span>
          </div>
        </div>
          ...
          <div class="content__space-list">
            ...
            <div class="space-list__add-space">
              <button class="add-space__button">
                ...
                <span v-show="isOpened">Добавить пространство</span>
              </button>
            </div>
          </div>
        </div>
    ...
    <div class="leftside-bar-footer">
      <div class="footer__helper">
        ...
        <span v-show="isOpened">Помощь и начало работы</span>
      </div>
      <div class="footer__logout">
        <button class="logout__button">
          ...
          <span v-show="isOpened">Выйти</span>
        </button>
      </div>
    </div>
  </aside>
